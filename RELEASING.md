...
`https://github.com/ajaymahato431/filament-mcp/settings/secrets/actions/new`.
...
npx -y filament-mcp@latest --version    # expect the version you just published
npm view filament-mcp version
```
...
Watch it at `https://github.com/ajaymahato431/filament-mcp/actions`.
